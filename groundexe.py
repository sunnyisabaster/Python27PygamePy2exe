...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "itgame.py"
        # 游戏名
        self.project_name = "itgame"
        # 游戏site
        self.project_url = "about:none"
        # 游戏版本
        self.project_version = "0.0"
        # 游戏许可
        self.license = "itgame License"
        # 游戏作者
        self.author_name = "suuny"
        # 联系电邮
        self.author_email = "525226851@qq.com"
        # 游戏版权
        self.copyright = "Copyright (c) 3000 suuny."
        # 游戏描述
        self.project_description = "itgame Description"
